...
![Decoding Process: Parsing the binary string from left to right, we select the 6th subset 1,3⇒Webcam, Headphones and the 9th subset 2,4⇒Shoes, Socks as the optimal bundles to purchase.](https://cdn-images-1.medium.com/max/800/1*dPqlRvUniBGLV5d789ONjQ.png align="left")
...
You can also run this on a real hardware via [IBM's Quantum Lab](https://quantum.ibm.com/).
...
* Supreeth Mysore Venkatesh, Antonio Macaluso, and Matthias Klusch. “BILP-Q: Quantum Coalition Structure Generation.” 19th ACM International Conference on Computing Frontiers (CF’22), May 17–19, 2022, Torino, Italy. [Paper Link](https://doi.org/10.1145/3528416.3530235), [arXiv Preprint](https://arxiv.org/abs/2204.13802)
